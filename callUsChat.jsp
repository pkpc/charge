        ...
        $('#appointment').on('click',function () {
            ...
            $.ajax({
                ...
                beforeSend:function(xhr){
                    xhr.setRequestHeader("Authorization","Bearer ZTY0NjI1ODVmOTE4MzRiY2Y1ZTczYzM4NzE5ODZmZDE5MGFlMjYzOGVkZTVmNjdjYjlhZGU1MTc4NWQ4MWQ4Yw");
                },
                success:function (data) {
//                    var data = JSON.parse(res);
                    if(data.result == 0){
                        $('#modalTip').css('display','block');
                        $('#appointment').css('backgroundColor','#cccccc');
